                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <a href="?page=karyawanjabatan&id=<?php echo $row['id'] ?>" class="btn bg-purple btn-sm mr-1"><i class="fa fa-building"></i> <?php echo $jabatan_terkini ?></a>
                            </td>
                            <td>
                                <a href="?page=karyawanupdate&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm mr-1">
                                    <i class="fa fa-edit"></i> Ubah
                                </a>
                                <a href="?page=karyawandelete&id=<?php echo $row['id'] ?>&pengguna_id=<?php echo $row['pengguna_id'] ?>" class="btn btn-danger btn-sm" onclick="javascript: return comfirm('Konfirmasi data akan dihapus');">
