                ...
                <div class="card-body">
                    ...
                    <table id="mytable" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            $selectSql = "SELECT JK.*, J.nama_jabatan FROM jabatan_karyawan JK LEFT JOIN jabatan J ON JK.jabatan_id = J.id WHERE JK.karyawan_id = ? ORDER BY tanggal_mulai DESC";
