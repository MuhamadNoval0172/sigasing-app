        ...
        <div class="card-body">
            <table id="mytable" class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    $selectSql = "SELECT B.*, k.nama_lengkap nama_kepala_bagian, L.nama_lokasi nama_lokasi_bagian FROM bagian B LEFT JOIN karyawan K ON B.karyawan_id = K.id
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="?page=bagiandelete&id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm" onclick="javascript: return comfirm('Konfirmasi data akan dihapus');">
